...
urlpatterns = [
    ...
    path('partner/<int:id>/detail/', PartnerDetail.as_view(),
         name='partner_detail_page_url'),
    ...
    path('contractor/<int:id>/detail/', ContractorDetail.as_view(),
         name='contractor_detail_page_url'),


    path('cards/', CardList.as_view(), name='card_list_url'),
    path('cards/detail', cardDetailRequest, name='card_detail_url'),
    path('card/<int:id>/detail/', CardDetail.as_view(),
         name='card_detail_page_url'),


    path('stations/', StationList.as_view(), name='station_list_url'),
    path('stations/detail', stationDetailRequest, name='station_detail_url'),
    path('station/<int:id>/detail/', StationDetail.as_view(),
         name='station_detail_page_url'),
    ...
    path('post/<int:id>/update_erip/', PostUpdateEripId.as_view(),
         name='post_update_erip_id_url'),
    path('post/<int:id>/detail/', PostDetail.as_view(),
         name='post_detail_page_url'),
    ...
    path('user_profile/update/', UserProfileUpdate.as_view(),
         name='user_profile_update_url'),

    path('epos-payment/', eposPaymentRequest,
         name='epos_payment_request_url'),
    path('epos-payments/', EposPaymentList.as_view(),
